...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        public void Can_Use_Repository()
        {
            ...
            // Assert
            Product[] prodArray = result.ToArray(); Assert.True(prodArray.Length == 2); Assert.Equal("P1", prodArray[0].Name);
            ...
            { // Arrange
              Mock<IStoreRepository> mock = new Mock<IStoreRepository>(); 
                ...
                // Assert
                Product[] prodArray = result.ToArray(); Assert.True(prodArray.Length == 2);
